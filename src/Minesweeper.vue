<template>
    <div class="games">
        ...
        <div class="row center">
            <div id="minesweeper">
                <div class="header_sweeper">
                    <div class="header__sweeper__timer">{{ turn }}</div>
                    <div class="header__sweeper__status">{{ status }}</div>
                    <div class="header__sweeper__smiley">:)</div>
                </div>
                <div class="board_sweeper">
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_0  }" data-index="0" @click = pass_turn_0()>{{ data_index_0 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_1  }" data-index="1" @click = pass_turn_1()>{{ data_index_1 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_2  }" data-index="2" @click = pass_turn_2()>{{ data_index_2 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_3  }" data-index="3" @click = pass_turn_3()>{{ data_index_3 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_4  }" data-index="4" @click = pass_turn_4()>{{ data_index_4 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_5  }" data-index="5" @click = pass_turn_5()>{{ data_index_5 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_6  }" data-index="6" @click = pass_turn_6()>{{ data_index_6 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_7  }" data-index="7" @click = pass_turn_7()>{{ data_index_7 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_8  }" data-index="8" @click = pass_turn_8()>{{ data_index_8 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_0  }" data-index="0" @click = pass_turn_0()>{{ data_index_0 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_1  }" data-index="1" @click = pass_turn_1()>{{ data_index_1 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_2  }" data-index="2" @click = pass_turn_2()>{{ data_index_2 }}</div>
                    <div class="board__tile__sweeper" v-bind:class="{ board__tile__winner: isActive_3  }" data-index="3" @click = pass_turn_3()>{{ data_index_3 }}</div>
